...
from stream_mapper.core import Data, NNField
...
if TYPE_CHECKING:
    ...
    from stream_mapper.core.typing import BoundsT

    from stream_mapper.pytorch.typing import NNModel
...
class IsochroneMVNorm(ModelBase):
    ...
    ::
        ...
        from stream_mapper.pytorch.builtin import IsochroneMVNorm
