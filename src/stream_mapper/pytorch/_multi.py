...
from stream_mapper.core import MixtureModel as CoreMixtureModel
from stream_mapper.core import ModelsBase as CoreModelsBase
...
class IndependentModels(ModelsBase, CoreIndependentModels[Array, NNModel]):
    ...
    name : str or None, optional keyword-only
        ...
        a mixture model (see :class:`~stream_mapper.core.IndependentModels`).
